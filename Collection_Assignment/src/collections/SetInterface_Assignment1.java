...
public class SetInterface_Assignment1 
{
		...
		public static Set<Student> findUnique(List<Student> students) {
			...
			HashSet<Student> unique=new HashSet<Student>();
			for(Student uniquelements:students)
			{
				unique.contains(uniquelements);
				unique.add(uniquelements);
			}
			return unique;
		}
		...
		public static Set<Student> findDuplicates(List<Student> students)
		{
			...
			//Implement your logic here and change the return statement accordingly
			HashSet<Student> duplicate= new HashSet<>();
